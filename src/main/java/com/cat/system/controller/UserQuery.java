...
public class UserQuery extends BaseNqtQuery<User>{
	...
	public String get_user(String org_id) throws Exception {
		List<User> users = (List<User>)baseService.getList("Organ", "system", "User_by_Organ", NameQueryUtil.setParams("organId",org_id));
