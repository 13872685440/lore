...
public class PostInformationHome extends BaseHome<PostInformation> {
	...
	@RequestMapping(value = "/userbyorg", method = RequestMethod.GET)
	public String userByOrg(String organ_id) {
		List<PostInformation> pis = (List<PostInformation>) baseService.getList("PostInformation", "o.organId asc",
				true, NameQueryUtil.setParams("organId", organ_id));
		return ResultBean.getSucess(pis);
	}
}
