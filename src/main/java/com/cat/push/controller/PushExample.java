...
public class PushExample {
    ...
    protected static final String APP_KEY = "30981aaece709171f3671274";
    protected static final String MASTER_SECRET = "14c035c74ca317d85dbef361";
    ...
    public static void pushTask() {
	    ...
	    final JPushClient jpushClient = new JPushClient("14c035c74ca317d85dbef361", "30981aaece709171f3671274", null, clientConfig);
	    PushPayload payload = getPushPayload(1,"test","test");
	    try {
	 ...
	 public static PushPayload getPushPayload(int type,String message,String title) {
	        return PushPayload.newBuilder()
	                .setPlatform(Platform.all())
	                .setAudience(Audience.registrationId("13065ffa4e63b5bf502"))
