...
public class ProcessStepHome extends BaseHome<ProcessStep>{
	...
	public String save(ProcessStep entity) throws Exception {
		...
		if("1".equals(entity.getCsr_type())){
			entity.setCs_userIds(StringUtil.listToString(entity.getCs_user_s()));
			
			entity.setCs_role_s(null);
			entity.setCs_role_type(null);
			entity.setCs_organIds(null);
			entity.setCs_ld_roles(null);
		} else if("2".equals(entity.getCsr_type())) {
			entity.setCs_userIds(null);
			
			entity.setCs_roles(StringUtil.listToString(entity.getCs_role_s()));
			if("3".equals(entity.getCs_role_type())) {
				entity.setCs_organIds(StringUtil.listToString(entity.getCs_organ_s()));
			} else {
				entity.setCs_organ_s(null);
			}
			entity.setCs_ld_roles(null);
		} else if("3".equals(entity.getCsr_type())) {
			entity.setCs_userIds(null);
			entity.setCs_role_s(null);
			entity.setCs_role_type(null);
			entity.setCs_organIds(null);
			entity.setCs_ld_roles(StringUtil.listToString(entity.getCs_ld_role_s()));
		} else {
			entity.setCs_userIds(null);
			entity.setCs_ld_roles(null);
			entity.setCs_role_s(null);
